...
QNNs are a promising approach to machine learning on quantum hardware, for which ideas from classical neural networks can be applied, but the lack of backpropagation and potentially vanishing gradients are a challenge.
