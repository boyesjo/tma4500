...
It was however only really with the discovery of Shor's algorithm \cite{shor} in 1994 that the potential of quantum computers gained widespread attention.
