...
It is one of Nature's great mysteries what exactly a measurement is, but in the quantum computational setting, it can be thought of as taking a random sample with the probabilities given by the absolute square of the coefficients.
...
There is a global phase which is not measurable, it can not be observed, and it is not physically relevant.
