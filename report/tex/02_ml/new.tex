...
With probabilistic models, the model insteads attemps to reconstruct the conditional probability distribution $p(y|\bm{x})$.
In statistics, this distribution will often be of a known type which is paramatrised by a function of the data and some parameters.
...
Maximum likelihood estimatiom can be used, switching only the sign to conform with machine learning conventions, leading to the negative log-likelihood loss.
