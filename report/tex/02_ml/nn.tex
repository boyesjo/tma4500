...
RNNs' flexibility permits them to take inputs of varying length, which is not natively supported by feed-forward NNs.
However, this flexibility comes at a cost.
As the network is allowed to have cycles, the gradient of the node parameters can vanish or explode exponentially, which makes training more difficult.
