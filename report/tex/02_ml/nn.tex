...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            (axis cs:0,\myY) -- (axis cs:9,\myY) node[midway]{\footnotesize Classical};
            \draw[decoration={brace,raise=-10pt}, decorate]
            (axis cs:12,\myY) -- (axis cs:65,\myY) node[midway]{\footnotesize Modern};
        \end{axis}
    \end{tikzpicture}
    \caption{
        ...
        The data is from \cite{nakkiran2021}, where ResNet18 models was used for image classification with added label noise.
    }
