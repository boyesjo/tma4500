...
\begin{figure}
    ...
    \caption{
        A dense feed-forward neural network with four hidden layers, each with five nodes.
        From \cite{nn_figs}.
    }
    \label{fig:nn}
\end{figure}
...
It is feedforward, because the data flows in one direction; the perceptrons in a layer depends only on those in the former.
