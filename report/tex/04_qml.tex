...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[mark=none, color=blue] table[x index=0, y index=2, col sep=comma] {../code/iris/results/mean.csv};
            \addplot[mark=none, color=red] table[x index=0, y index=3, col sep=comma] {../code/iris/results/mean.csv};
            \addplot[mark=none, color=green] table[x index=0, y index=1, col sep=comma] {../code/iris/results/mean.csv};
            \legend{QNN, QNN with noise, NN}
        \end{axis}
    \end{tikzpicture}
