...
One can differentiate between the type of the data being processed and the way of processing these data, giving the following table [ibid.]:
...
\begin{description}
    ...
    \item[QC]
        ...
        In the fault-tolerant setting, speed-ups can be achieved using fast quantum procedures for linear algebra, e.g., by using HHL to invert matrices in linear regression \cite{wiebe2012}.
