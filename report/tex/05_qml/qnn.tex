...
There, qubits are grouped together to represent one neuron, and the measurements can be used to approximate activation functions by piecewise constant functions.
